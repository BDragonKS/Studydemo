...
/**
 * Created by Dragon on .
 */

public abstract class TreeViewAdapterNew extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public TreeViewAdapterNew(Context context, TreeNode root,
    ...
    @NonNull
    @Override
    public BaseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int level) {
...
//        layoutParams.setMarginStart(treeNode.getLevel() * 30);
        nodeView.setPadding(treeNode.getLevel() * 30, 0, 0, 0);
//        nodeView.setLayoutParams(layoutParams);
    ...
    public abstract void convert(BaseViewHolder holder, TreeNode node);
}
