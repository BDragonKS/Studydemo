package com.jinglu.studydemo.main;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            HrefUtil.getInstance().hrefActivity(this, KotlinActivity.class);
        } else if (id == R.id.nav_tree) {

            HrefUtil.getInstance().hrefActivity(this, TreeDemoActivity.class);
